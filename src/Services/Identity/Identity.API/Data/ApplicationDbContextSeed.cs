...
namespace MicroservicesExample.Services.Identity.API.Data
{
    public class ApplicationDbContextSeed
    {
        ...
        private IEnumerable<ApplicationUser> GetDefaultUser()
        {
            ...
            new ApplicationUser()
            {
                ...
                City = "Da Nang",
                Country = "Vietnam",
                Email = "microservices@example.com",
                Expiration = "12/20",
                Id = Guid.NewGuid().ToString(),
                LastName = "DemoLastName",
                Name = "DemoUser",
                PhoneNumber = "1234567890",
                UserName = "ms@example.com",
                ZipCode = "550000",
                State = "Hai Chau",
                Street = "81 Quang Trung",
                SecurityNumber = "535",
                NormalizedEmail = "microservices@example.com",
                NormalizedUserName = "microservices@example.com",
                SecurityStamp = Guid.NewGuid().ToString("D"),
            };
